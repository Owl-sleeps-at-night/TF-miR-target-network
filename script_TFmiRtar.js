...
// 下载文件的事件监听器
document.getElementById("download1").removeEventListener("click", handleDownload);
document.getElementById("download1").addEventListener("click", handleDownload);
function handleDownload() {
    downloadDataAsTabDelimited(globalMiRTargetData, 'miRNA-Target-Data.txt');
}
document.getElementById("download2").removeEventListener("click", handleDownload);
document.getElementById("download2").addEventListener("click", handleDownload);
function handleDownload() {
