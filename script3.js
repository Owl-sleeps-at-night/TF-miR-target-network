...
async function  runiPredictLogic(){
    ...
    document.getElementById("ART_yes").classList.add("active");
...
async function runDNADCLogic(){
    ...
    document.getElementById("ART_yes_dnadc").classList.add("active");
    document.getElementById("ART_no_dnadc").classList.remove("active");
    filterSubcellularLocations1();

// 为YES和NO按钮添加事件监听
    document.getElementById("ART_yes_dnadc").addEventListener("click", () => {
        setARTCondition("ART");
    });
    document.getElementById("ART_no_dnadc").addEventListener("click", () => {
        setARTCondition("nonART");
    ...
    function setARTCondition(condition) {
        ...
        // 更新按钮的状态
        document.getElementById("ART_yes_dnadc").classList.toggle("active", condition === "ART");
        document.getElementById("ART_no_dnadc").classList.toggle("active", condition === "nonART");
...
function displaySubcellularTable(subcellularCount) {
    ...
    sortedLocations.forEach(location => {
        ...
        // 默认选中的 Subcellular Locations
        const defaultSelectedLocations = ['Cytoplasm', 'Cytosol'];
